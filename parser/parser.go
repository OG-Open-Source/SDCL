...
func (p *Parser) parseStatement() ast.Statement {
	...
	case token.KEY:
		return p.parseKeyValuePair()
	default:
		return p.parseExpressionStatement()
	}
}

func (p *Parser) parseKeyValuePair() *ast.KeyValuePair {
	stmt := &ast.KeyValuePair{Token: p.curToken}
...
func (p *Parser) parseObjectLiteral() ast.Expression {
	literal := &ast.ObjectLiteral{Token: p.curToken}
